...
<%
   ArrayList<Product> list 
    ...
    for(int i=0;i<list.size();i++){	
    	String sql1 = "insert into tt_sale(saledate, sessionId, name ,productId, unitprice, saleqty, status ) values (?,?,?,?,?,?,1)";
    ...
    String sql2="insert into tt_delivery(sessionId,name,deliverydate,nation,zipcode,address) values(?,?,?,?,?,?)";
